...
urlpatterns = [
    ...
    path('experimental_director_panel/', experimental_director_panel.DirectorPanelView.as_view(), name = 'experimental_director_panel'),
    path('edit_user/', edit_user.EditUserView.as_view(), name = 'edit_user'),
    path('<pk>/experimental_edit_user/', experimental_edit_user.EditUserView.as_view(), name = 'experimental_edit_user'),
